...
const create_schemas = {
  ...
  assignments: [
    { key: 'production_order_id', label: 'Lệnh sản xuất', lookup: 'production_orders', required: true }, { key: 'employee_id', label: 'Nhân viên', lookup: 'employees', required: true }, { key: 'work_shift_id', label: 'Ca làm việc', lookup: 'work_shifts', required: false }, { key: 'assignment_name', label: 'Nhiệm vụ', required: false },
