...
public class human_resources_contract_controller {
    ...
    @DeleteMapping("/{employment_contract_id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    @PreAuthorize("hasAuthority('hr_contract_delete')")
    public void delete(@PathVariable long employment_contract_id,
                       @AuthenticationPrincipal authenticated_user actor,
                       HttpServletRequest http_request) {
        contract_service.delete(employment_contract_id, actor, correlation_id(http_request));
    }
