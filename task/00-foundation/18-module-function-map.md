...
| 4 | Chất lượng và giá thành | Kiểm tra chất lượng; xử lý không phù hợp; tính giá thành; đề xuất/ra quyết định điều chỉnh giá; phê duyệt bảng giá | docs/erp nhóm 4.docx |
...
- Dữ liệu và báo cáo vẫn deferred; chất lượng và giá thành đã được ưu tiên lại để triển khai MVP theo task/README.md.
